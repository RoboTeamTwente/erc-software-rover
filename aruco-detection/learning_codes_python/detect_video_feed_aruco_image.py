...
# === Output video writer ===
output_path = "/home/andrei/erc-software/aruco-detection/annotated_output.mkv"
...
while True:
    ...
    if marker_ids is not None:
        ...
        aruco.drawDetectedMarkers(frame, marker_corners, marker_ids, border_color)
        ...
        for corners, marker_id_arr, rvec, tvec in zip(
            ...
            id_last_seen[marker_id] = frame_count
