...
filename = "aruco-detection/charuco_camera_params.yml"
...
# === Video source ===
cap = cv2.VideoCapture("https://145.126.44.42:8080/video")
...
# --- Enable subpixel refinement (more stable pose) ---
# parameters.cornerRefinementMethod = aruco.CORNER_REFINE_SUBPIX
# parameters.cornerRefinementWinSize = 8  # 5x5 search window (default 5)
# parameters.cornerRefinementMaxIterations = 30
# parameters.cornerRefinementMinAccuracy = 0.002

detector = aruco.ArucoDetector(dictionary, parameters)
marker_length = 0.05  # meters (5 cm)

# === Pose smoothing + memory ===
ALPHA = 0.5  # smoothing factor (higher = smoother, slower)
prev_tvec = {}
prev_rvec = {}
